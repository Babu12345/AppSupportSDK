    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-3xl mx-auto bg-white dark:bg-slate-900 rounded-lg shadow dark:shadow-slate-800/50 p-8">
        ...
        <div className="space-y-6 text-gray-700 dark:text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">5. Data Storage and Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">7. Your Rights</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">8. Children&apos;s Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">10. Contact Us</h2>
            <p>
